    ...
    <div class="container">
        ...
        <div class="row">
            ...
            if ($approvedEventCount > $approvedItemsPerPage) {
                ...
                echo '<a class="page-link" href="?approved_page=' . max(1, $approvedCurrentPage - 1) . '" aria-label="Previous">';
                echo '<span aria-hidden="true">&laquo;</span>';
                echo '<span class="sr-only">Previous</span>';
                echo '</a>';
                echo '</li>';
                for ($i = 1; $i <= $approvedTotalPages; $i++) {
                    echo '<li class="page-item ' . ($approvedCurrentPage == $i ? 'active' : '') . '"><a class="page-link" href="?approved_page=' . $i . '">' . $i . '</a></li>';
                }
                echo '<li class="page-item ' . ($approvedCurrentPage == $approvedTotalPages ? 'disabled' : '') . '">';
                echo '<a class="page-link" href="?approved_page=' . min($approvedTotalPages, $approvedCurrentPage + 1) . '" aria-label="Next">';
